# Generated by Django 2.2.4 on 2019-08-03 22:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', model_utils.fields.StatusField(choices=[('draft', 'Draft'), ('pending', 'Pending'), ('printed', 'Printed'), ('submitted', 'Submitted'), ('approved', 'Approved'), ('rejected', 'Rejected'), ('closed', 'Closed')], default='draft', max_length=100, no_check_for_status=True, verbose_name='status')),
                ...
                ('bank_transfer_date', models.DateField(blank=True, null=True, verbose_name='Transfer date')),
            ...
            options={
                ...
                'ordering': ('-created',),
                'permissions': (('manage_reimbursements', 'Submit reimbursements for approval'), ('can_approve_reimbursements', 'Approve or reject reimbursements'), ('receive_approved_notifications', 'Receive notifications about the approved reimbursements')),
            },
        ),
        migrations.CreateModel(
            name='Expense',
            fields=[
                ...
                ('requisition_number', models.IntegerField(blank=True, null=True, verbose_name='Requisition number')),
                ...
                ('value', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='EUR', max_digits=11, validators=[djmoney.models.validators.MinMoneyValidator(djmoney.money.Money(0.01))], verbose_name='Amount')),
                ('eur_value', models.DecimalField(decimal_places=2, max_digits=11, verbose_name='Amount in EUR')),
                ('is_social', models.BooleanField(default=False, verbose_name='It is a social expense')),
                ('receipt', models.FileField(upload_to=reimbursements.models.expense.user_directory_path, verbose_name='Receipt')),
                ('receipt_date', models.DateField(default=None, null=True, verbose_name='Receipt date')),
                ('expensecode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reimbursement_expenses', to='finance.ExpenseCode', verbose_name='Expense code')),
